...
export const promisePillars: Pillar[] = [
  {
    ...
    description: {
      fr: "Identifier et développer le potentiel unique de chaque joueur.",
      en: "Identify and develop each player's unique potential.",
    },
    icon: "Star",
  },
  {
    ...
    description: {
      fr: "Un parcours scolaire structuré au cœur de notre mission.",
      en: "A structured academic path at the heart of our mission.",
    },
    icon: "GraduationCap",
  },
  {
    ...
    description: {
      fr: "Des outils modernes pour mesurer et optimiser la progression.",
      en: "Modern tools to measure and optimize progress.",
    },
    icon: "TrendingUp",
  },
  {
    ...
    description: {
      fr: "Former des leaders sur et en dehors du terrain.",
      en: "Building leaders on and off the pitch.",
    },
    icon: "Crown",
  },
];
